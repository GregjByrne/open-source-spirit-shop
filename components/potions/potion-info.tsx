...
import { PotionHearder, PotionInfoCard, PotionStats } from "@/components/potions/potion-common";
...
export default function PotionInfo({ potion }: 
    PotionInfoType){
    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1">
          ...
          >
            <PotionHearder name={name} owner={owner} size="medium" />
